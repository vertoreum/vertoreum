...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s vertoreum-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  vertoreum-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded vertoreum transaction") + "\n" +
              "  vertoreum-tx [options] -create [commands]   " + _("Create hex-encoded vertoreum transaction") + "\n" +
              "\n";
