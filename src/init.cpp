...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/Vertoreum/Vertoreum>";
    const std::string URL_WEBSITE = "</>";
    const std::string URL_EXPLORER = "</>";
    const std::string URL_OFFICIALPOOL = "</>";
    const std::string URL_WALLETS = "<https://github.com/Vertoreum/Vertoreum/releases/latest>";
    const std::string URL_DISCORD = "<https://discord.gg/>";
    const std::string URL_TWITTER = "<https://twitter.com/>";
