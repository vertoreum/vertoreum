...
void RPCConsole::clear(bool clearHistory)
{
    ...
    ui->messagesWidget->document()->setDefaultStyleSheet(
        QString(
                ...
                "td.message { color: #4A8652; font-weight: bold; font-family: calibri; font-size: 14px; white-space:pre-wrap; } "
                "td.cmd-request { color: #383838; font-family: calibri; font-size: 12px; } "
                "td.cmd-error { color: #BA683B; } "
                ".secwarning { color: #BA683B; }"
                "b { color: #65B76F; font-family: calibri; font-size: 11px;} "
