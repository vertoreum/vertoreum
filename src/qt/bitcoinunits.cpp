...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("VTRM");
    case mBTC: return QString("mVTRM");
    case uBTC: return QString::fromUtf8("μVTRM");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Vertoreums");
    case mBTC: return QString("Milli-Vertoreums (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Vertoreums (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
